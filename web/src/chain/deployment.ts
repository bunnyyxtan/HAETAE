// Typed view over the committed deployment record, the single source of
// truth for live addresses. deployments/giwa-sepolia.json is written by the
// deploy script; nothing here is hand-maintained.

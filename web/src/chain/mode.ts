// Sandbox mode: ?sandbox pins the console to the bundled fixture dataset,
// no RPC traffic at all. ?demo=fixtures is honored as a legacy alias so
// existing walks don't break. The flag is read once

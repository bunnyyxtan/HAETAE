...
/// @title TestUSDC — worthless 6-decimal test token for the GIWA Sepolia demo
/// @notice Exists so the ReferenceVault has something to move on stage (Session 04 order:
